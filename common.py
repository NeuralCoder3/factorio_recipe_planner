...
quality_module_percentage = 0.02 # 2% for quality module level 2
quality_module_speed_percentage = -0.05 # 5% speed reduction per quality module level 2
productivity_module_percentage = 0.06 # 6% for productivity module level 2
productivity_module_speed_percentage = -0.10 # 10% speed reduction per productivity module level 2
speed_module_percentage = 0.3 # 30% for speed module level 2
speed_module_quality_percentage = -0.015 # 1.5% quality reduction per speed module level 2

beacon_efficiency = 1.5 # normal quality beacon efficiency
...
speed_module_name = "speed lv 2"
beacon_name = "normal beacon"
...
recycle_times = {
    ...
    # time (in s) per item (seems to be original crafting time divided by 8)
    "processing_unit": 1/0.8,
    "advanced_circuit": 1/1.33,
    ...
    for ri, recipe in enumerate(recipes):
        ...
        recycle_recipes.append(
            Recipe(
                ...
                crafting_time=recycle_times.get(output_item, recipe.crafting_time / 8),
